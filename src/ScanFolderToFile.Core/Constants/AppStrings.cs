...
public static class AppStrings
{
    ...
    public static class System
    {
        ...
        public const string SelectorCopy = "copy:";
        public const string SelectorCut = "cut:";
        public const string SelectorPaste = "paste:";
        public const string SelectorDelete = "delete:";
        public const string SelectorSelectAll = "selectAll:";
        public const string SelectorToggleBoldface = "toggleBoldface:";
        public const string SelectorToggleItalics = "toggleItalics:";
        public const string SelectorUndo = "undo:";
        public const string SelectorRedo = "redo:";
        public const string SelectorUnderline = "underline:";
        public const string SelectorAlignLeft = "alignLeft:";
        public const string SelectorAlignCenter = "alignCenter:";
        public const string SelectorAlignRight = "alignRight:";
        public const string SelectorOrderFrontFontPanel = "orderFrontFontPanel:";
        ...
        public const string HyphenWithTrailingSpace = "- ";
    ...
    public static class Ui
    {
        ...
        public const string ZipGenerateSuccessPrefix = "Archivio creato: ";
        ...
        public const string NativeEditorReadyStatus = "Editor nativo pronto.";
        public const string NativeEditorCursorStatusPrefix = "Riga ";
        public const string NativeEditorColumnSeparator = ", Colonna ";
        public const string NativeEditorPreviewLoadedStatus = "Contenuto caricato nel documento nativo.";
        public const string NativeEditorWrapEnabledStatus = "A capo automatico attivato.";
        public const string NativeEditorWrapDisabledStatus = "A capo automatico disattivato.";
        public const string NativeEditorSaveRequiredStatus = "Salva il documento prima di continuare.";
        public const string NativeEditorNewButtonText = "Nuovo";
        public const string NativeEditorUndoButtonText = "Undo";
        public const string NativeEditorRedoButtonText = "Redo";
        public const string NativeEditorCutButtonText = "Taglia";
        public const string NativeEditorCopyButtonText = "Copia";
        public const string NativeEditorPasteButtonText = "Incolla";
        public const string NativeEditorDeleteButtonText = "Elimina";
        public const string NativeEditorSelectAllButtonText = "Seleziona tutto";
        public const string NativeEditorWrapButtonText = "A capo";
        public const string NativeEditorFontButtonText = "Font...";
        public const string NativeEditorGrowFontButtonText = "A+";
        public const string NativeEditorShrinkFontButtonText = "A-";
        public const string NativeEditorBoldButtonText = "Grassetto";
        public const string NativeEditorItalicButtonText = "Corsivo";
        public const string NativeEditorUnderlineButtonText = "Sottolinea";
        public const string NativeEditorAlignLeftButtonText = "Sinistra";
        public const string NativeEditorAlignCenterButtonText = "Centro";
        public const string NativeEditorAlignRightButtonText = "Destra";
        public const string NativeEditorBulletsButtonText = "Elenco";
        public const string NativeEditorLowerCaseButtonText = "minuscolo";
        public const string NativeEditorUpperCaseButtonText = "MAIUSCOLO";
        public const string NativeEditorZoomInButtonText = "Zoom +";
        public const string NativeEditorZoomOutButtonText = "Zoom -";
        public const string NativeEditorPreviewButtonText = "Anteprima";
        public const string NativeEditorPrintButtonText = "Stampa";
        public const string NativeEditorUnsupportedExtensionStatus = "Formato non modificabile direttamente: viene aperto il contenuto in un nuovo documento.";
        public const string NativePrintPanelReadyStatus = "Pannello di stampa nativo aperto.";
        public const string NativePrintFallbackStatus = "Anteprima nativa non disponibile: attivo il fallback interno.";
    }
}
